...
import { IconProps, ArrowProps, SelectProps, FormikFieldProps } from '@/types'

const Icon = ({ className }: IconProps): React.JSX.Element => (
  <svg
...
const Arrow = ({ opened, className }: ArrowProps): React.JSX.Element => (
  <svg
...
const Select = ({ value, placeholder, error, onSelect }: SelectProps): React.JSX.Element => {
  ...
  const content = useMemo(() => {
    ...
    const occasion = _.find(occasions, { value })
...
const InputOccasion = ({ field, form }: FormikFieldProps): React.JSX.Element => {
