...
const Count = ({ children, error, selected }) => (
...
const Adults = ({ error, value, onChange }) => {
...
const Children = ({ error, value, onChange }) => {
  const handleIncrement = useCallback(() => {
...
const Pets = ({ error, value, onChange }) => {
  const handleIncrement = useCallback(() => {
