...
const InputFirstName = ({ field, form }: FormikFieldProps): React.JSX.Element => {
  ...
  return (
    <ErrorBoundary fallback={<div>Something went wrong</div>}>
      <div className={styles.Group}>
        <Label htmlFor={field.name} className={styles.Label} error={Boolean(error)}>First Name</Label>
        <input
